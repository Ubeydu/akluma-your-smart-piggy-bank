                ...
                <div class="py-4 px-6">
                    ...
                    <script>
                        window.Laravel = {
                            ...
                            routes: {
                                calculateFrequencies: '{{ route("create-piggy-bank.pick-date.calculate-frequencies", ["locale" => app()->getLocale()]) }}',
                                storeFrequency: '{{ route("create-piggy-bank.pick-date.store-frequency", ["locale" => app()->getLocale()]) }}'
                            },
