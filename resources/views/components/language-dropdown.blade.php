<x-dropdown>
    <x-slot name="trigger">
        <div x-data="{ open: false }" @click="open = !open" class="block w-full px-4 py-2 text-start text-sm leading-5 text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out cursor-pointer flex items-center justify-between">
