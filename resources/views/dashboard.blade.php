    ...
    <div class="py-4 px-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative">
            ...
            <div class="relative rounded-lg overflow-hidden">
                ...
                <div class="absolute inset-0 bg-white/60 backdrop-blur-[0.5px] z-10"></div>
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div class="mt-2">
                                <span class="text-xs text-green-500 inline-flex items-center">
                                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" d="M12 7a1 1 0 01-1 1H9a1 1 0 01-1-1V6a1 1 0 011-1h2a1 1 0 011 1v1zm-3 5a1 1 0 011-1h2a1 1 0 011 1v1a1 1 0 01-1 1H9a1 1 0 01-1-1v-1z" clip-rule="evenodd"></path>
                                    </svg>
                    ...
                    <div class="p-5 border rounded-lg shadow-md bg-white relative">
                        ...
                        <div>
                            <span class="text-2xl font-bold text-gray-900">$2,750.00</span>
                            <div class="mt-2">
                                <div class="w-full h-2.5 bg-gray-200 rounded-full overflow-hidden">
                                    <div class="bg-indigo-500 h-full rounded-full" style="width: 31%"></div>
                                </div>
                                <span class="text-xs text-gray-500 mt-1 block">31% {{ __('of goal completed') }}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-5">
                            <div class="flex items-center justify-center h-48">
                                ...
                                <div class="text-center">
                                    <div class="rounded-full w-32 h-32 mx-auto mb-4" style="background: conic-gradient(#4F46E5 0% 40%, #10B981 40% 65%, #F59E0B 65% 85%, #6B7280 85% 100%);"></div>
