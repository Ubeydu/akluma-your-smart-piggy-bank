        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ localizedRoute('localized.vaults.store') }}">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="details"
                                      ...
                                      maxlength="5000"
                                      class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-900"
                                      placeholder="{{ __('Describe what this vault represents (e.g., which bank account, which physical location, etc.)') }}">{{ old('details') }}</textarea>
                            @error('details')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
