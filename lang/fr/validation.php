...
return [
    ...
    */
    ...
    'attributes' => [
        'name' => 'nom',                           // 'nom' is masculine, means "name"
        'price_whole' => 'prix',                   // 'prix' is masculine, means "price"
        'price_cents' => 'centimes',               // 'centimes' is masculine plural, means "cents"
        'starting_amount_whole' => 'montant initial', // 'montant' is masculine, 'initial' means "starting"
        'starting_amount_cents' => 'centimes initiaux', // 'initiaux' is plural form of 'initial'
        'currency' => 'devise',                    // 'devise' is feminine, means "currency"
        'link' => 'lien',                         // 'lien' is masculine, means "link"
        'details' => 'détails',                   // 'détails' is masculine plural
    ],
];
