...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.available_languages.tr' => 'string',
            'app.available_languages.en' => 'string',
            'app.available_languages.fr' => 'string',
            'app.default_currency' => 'string',
            'app.currencies.TRY.name' => 'string',
            'app.currencies.TRY.decimal_places' => 'integer',
            'app.currencies.USD.name' => 'string',
            'app.currencies.USD.decimal_places' => 'integer',
            'app.currencies.GBP.name' => 'string',
            'app.currencies.GBP.decimal_places' => 'integer',
            'app.currencies.EUR.name' => 'string',
            'app.currencies.EUR.decimal_places' => 'integer',
            'app.currencies.XOF.name' => 'string',
            'app.currencies.XOF.decimal_places' => 'integer',
            'app.currencies.XAF.name' => 'string',
            'app.currencies.XAF.decimal_places' => 'integer',
            'app.reminders_test_mode' => 'boolean',
            ...
            'route-slugs.routes.dashboard.en' => 'string',
            'route-slugs.routes.dashboard.tr' => 'string',
            'route-slugs.routes.dashboard.fr' => 'string',
            'route-slugs.routes.piggy-banks.en' => 'string',
            'route-slugs.routes.piggy-banks.tr' => 'string',
            'route-slugs.routes.piggy-banks.fr' => 'string',
            'route-slugs.routes.profile.en' => 'string',
            'route-slugs.routes.profile.tr' => 'string',
            'route-slugs.routes.profile.fr' => 'string',
            'route-slugs.routes.create-piggy-bank.en' => 'string',
            'route-slugs.routes.create-piggy-bank.tr' => 'string',
            'route-slugs.routes.create-piggy-bank.fr' => 'string',
            'route-slugs.routes.terms-of-service.en' => 'string',
            'route-slugs.routes.terms-of-service.tr' => 'string',
            'route-slugs.routes.terms-of-service.fr' => 'string',
            'route-slugs.routes.privacy-policy.en' => 'string',
            'route-slugs.routes.privacy-policy.tr' => 'string',
            'route-slugs.routes.privacy-policy.fr' => 'string',
            'route-slugs.routes.login.en' => 'string',
            'route-slugs.routes.login.tr' => 'string',
            'route-slugs.routes.login.fr' => 'string',
            'route-slugs.routes.logout.en' => 'string',
            'route-slugs.routes.logout.tr' => 'string',
            'route-slugs.routes.logout.fr' => 'string',
            'route-slugs.routes.register.en' => 'string',
            'route-slugs.routes.register.tr' => 'string',
            'route-slugs.routes.register.fr' => 'string',
            'route-slugs.routes.forgot-password.en' => 'string',
            'route-slugs.routes.forgot-password.tr' => 'string',
            'route-slugs.routes.forgot-password.fr' => 'string',
            'route-slugs.routes.reset-password/{token}.en' => 'string',
            'route-slugs.routes.reset-password/{token}.tr' => 'string',
            'route-slugs.routes.reset-password/{token}.fr' => 'string',
            'route-slugs.routes.store-new-password.en' => 'string',
            'route-slugs.routes.store-new-password.tr' => 'string',
            'route-slugs.routes.store-new-password.fr' => 'string',
            'route-slugs.routes.verify-email.en' => 'string',
            'route-slugs.routes.verify-email.tr' => 'string',
            'route-slugs.routes.verify-email.fr' => 'string',
            'route-slugs.routes.verify-email-with-params.en' => 'string',
            'route-slugs.routes.verify-email-with-params.tr' => 'string',
            'route-slugs.routes.verify-email-with-params.fr' => 'string',
            'route-slugs.routes.email/verification-notification.en' => 'string',
            'route-slugs.routes.email/verification-notification.tr' => 'string',
            'route-slugs.routes.email/verification-notification.fr' => 'string',
            'route-slugs.routes.confirm-password.en' => 'string',
            'route-slugs.routes.confirm-password.tr' => 'string',
            'route-slugs.routes.confirm-password.fr' => 'string',
            'route-slugs.routes.password.en' => 'string',
            'route-slugs.routes.password.tr' => 'string',
            'route-slugs.routes.password.fr' => 'string',
            'route-slugs.routes.step-1.en' => 'string',
            'route-slugs.routes.step-1.tr' => 'string',
            'route-slugs.routes.step-1.fr' => 'string',
            'route-slugs.routes.step-2.en' => 'string',
            'route-slugs.routes.step-2.tr' => 'string',
            'route-slugs.routes.step-2.fr' => 'string',
            'route-slugs.routes.step-3.en' => 'string',
            'route-slugs.routes.step-3.tr' => 'string',
            'route-slugs.routes.step-3.fr' => 'string',
            'route-slugs.routes.pick-date.en' => 'string',
            'route-slugs.routes.pick-date.tr' => 'string',
            'route-slugs.routes.pick-date.fr' => 'string',
            'route-slugs.routes.summary.en' => 'string',
            'route-slugs.routes.summary.tr' => 'string',
            'route-slugs.routes.summary.fr' => 'string',
            'route-slugs.routes.enter-saving-amount.en' => 'string',
            'route-slugs.routes.enter-saving-amount.tr' => 'string',
            'route-slugs.routes.enter-saving-amount.fr' => 'string',
            'route-slugs.routes.clear.en' => 'string',
            'route-slugs.routes.clear.tr' => 'string',
            'route-slugs.routes.clear.fr' => 'string',
            'route-slugs.routes.choose-strategy.en' => 'string',
            'route-slugs.routes.choose-strategy.tr' => 'string',
            'route-slugs.routes.choose-strategy.fr' => 'string',
            'route-slugs.routes.show-summary.en' => 'string',
            'route-slugs.routes.show-summary.tr' => 'string',
            'route-slugs.routes.show-summary.fr' => 'string',
            'route-slugs.routes.store.en' => 'string',
            'route-slugs.routes.store.tr' => 'string',
            'route-slugs.routes.store.fr' => 'string',
            'route-slugs.routes.pause.en' => 'string',
            'route-slugs.routes.pause.tr' => 'string',
            'route-slugs.routes.pause.fr' => 'string',
            'route-slugs.routes.resume.en' => 'string',
            'route-slugs.routes.resume.tr' => 'string',
            'route-slugs.routes.resume.fr' => 'string',
            'route-slugs.routes.update-status-cancelled.en' => 'string',
            'route-slugs.routes.update-status-cancelled.tr' => 'string',
            'route-slugs.routes.update-status-cancelled.fr' => 'string',
            'route-slugs.routes.test-date/{piggy_id}.en' => 'string',
            'route-slugs.routes.test-date/{piggy_id}.tr' => 'string',
            'route-slugs.routes.test-date/{piggy_id}.fr' => 'string',
            'route-slugs.routes.test-date/{piggy_id}/clear.en' => 'string',
            'route-slugs.routes.test-date/{piggy_id}/clear.tr' => 'string',
            'route-slugs.routes.test-date/{piggy_id}/clear.fr' => 'string',
            'route-slugs.parameters.piggy_id.en' => 'string',
            'route-slugs.parameters.piggy_id.tr' => 'string',
            'route-slugs.parameters.piggy_id.fr' => 'string',
            'route-slugs.parameters.token.en' => 'string',
            'route-slugs.parameters.token.tr' => 'string',
            'route-slugs.parameters.token.fr' => 'string',
...
'app.aliases.Vite','app.available_languages.tr','app.available_languages.en','app.available_languages.fr','app.default_currency',
'app.currencies.TRY.name','app.currencies.TRY.decimal_places','app.currencies.USD.name','app.currencies.USD.decimal_places','app.currencies.GBP.name',
'app.currencies.GBP.decimal_places','app.currencies.EUR.name','app.currencies.EUR.decimal_places','app.currencies.XOF.name','app.currencies.XOF.decimal_places',
'app.currencies.XAF.name','app.currencies.XAF.decimal_places','app.reminders_test_mode','auth.defaults.guard','auth.defaults.passwords',
...
'queue.failed.database','queue.failed.table','route-slugs.routes.dashboard.en','route-slugs.routes.dashboard.tr','route-slugs.routes.dashboard.fr',
'route-slugs.routes.piggy-banks.en','route-slugs.routes.piggy-banks.tr','route-slugs.routes.piggy-banks.fr','route-slugs.routes.profile.en','route-slugs.routes.profile.tr',
'route-slugs.routes.profile.fr','route-slugs.routes.create-piggy-bank.en','route-slugs.routes.create-piggy-bank.tr','route-slugs.routes.create-piggy-bank.fr','route-slugs.routes.terms-of-service.en',
'route-slugs.routes.terms-of-service.tr','route-slugs.routes.terms-of-service.fr','route-slugs.routes.privacy-policy.en','route-slugs.routes.privacy-policy.tr','route-slugs.routes.privacy-policy.fr',
'route-slugs.routes.login.en','route-slugs.routes.login.tr','route-slugs.routes.login.fr','route-slugs.routes.logout.en','route-slugs.routes.logout.tr',
'route-slugs.routes.logout.fr','route-slugs.routes.register.en','route-slugs.routes.register.tr','route-slugs.routes.register.fr','route-slugs.routes.forgot-password.en',
'route-slugs.routes.forgot-password.tr','route-slugs.routes.forgot-password.fr','route-slugs.routes.reset-password/{token}.en','route-slugs.routes.reset-password/{token}.tr','route-slugs.routes.reset-password/{token}.fr',
'route-slugs.routes.store-new-password.en','route-slugs.routes.store-new-password.tr','route-slugs.routes.store-new-password.fr','route-slugs.routes.verify-email.en','route-slugs.routes.verify-email.tr',
'route-slugs.routes.verify-email.fr','route-slugs.routes.verify-email-with-params.en','route-slugs.routes.verify-email-with-params.tr','route-slugs.routes.verify-email-with-params.fr','route-slugs.routes.email/verification-notification.en',
'route-slugs.routes.email/verification-notification.tr','route-slugs.routes.email/verification-notification.fr','route-slugs.routes.confirm-password.en','route-slugs.routes.confirm-password.tr','route-slugs.routes.confirm-password.fr',
'route-slugs.routes.password.en','route-slugs.routes.password.tr','route-slugs.routes.password.fr','route-slugs.routes.step-1.en','route-slugs.routes.step-1.tr',
'route-slugs.routes.step-1.fr','route-slugs.routes.step-2.en','route-slugs.routes.step-2.tr','route-slugs.routes.step-2.fr','route-slugs.routes.step-3.en',
'route-slugs.routes.step-3.tr','route-slugs.routes.step-3.fr','route-slugs.routes.pick-date.en','route-slugs.routes.pick-date.tr','route-slugs.routes.pick-date.fr',
'route-slugs.routes.summary.en','route-slugs.routes.summary.tr','route-slugs.routes.summary.fr','route-slugs.routes.enter-saving-amount.en','route-slugs.routes.enter-saving-amount.tr',
'route-slugs.routes.enter-saving-amount.fr','route-slugs.routes.clear.en','route-slugs.routes.clear.tr','route-slugs.routes.clear.fr','route-slugs.routes.choose-strategy.en',
'route-slugs.routes.choose-strategy.tr','route-slugs.routes.choose-strategy.fr','route-slugs.routes.show-summary.en','route-slugs.routes.show-summary.tr','route-slugs.routes.show-summary.fr',
'route-slugs.routes.store.en','route-slugs.routes.store.tr','route-slugs.routes.store.fr','route-slugs.routes.pause.en','route-slugs.routes.pause.tr',
'route-slugs.routes.pause.fr','route-slugs.routes.resume.en','route-slugs.routes.resume.tr','route-slugs.routes.resume.fr','route-slugs.routes.update-status-cancelled.en',
'route-slugs.routes.update-status-cancelled.tr','route-slugs.routes.update-status-cancelled.fr','route-slugs.routes.test-date/{piggy_id}.en','route-slugs.routes.test-date/{piggy_id}.tr','route-slugs.routes.test-date/{piggy_id}.fr',
'route-slugs.routes.test-date/{piggy_id}/clear.en','route-slugs.routes.test-date/{piggy_id}/clear.tr','route-slugs.routes.test-date/{piggy_id}/clear.fr','route-slugs.parameters.piggy_id.en','route-slugs.parameters.piggy_id.tr',
'route-slugs.parameters.piggy_id.fr','route-slugs.parameters.token.en','route-slugs.parameters.token.tr','route-slugs.parameters.token.fr','services.postmark.token',
...
'web','api',);
        registerArgumentsSet('routes', 'localized.dashboard.tr','localized.dashboard.en','localized.dashboard.fr',
'localized.piggy-banks.index.tr','localized.piggy-banks.index.en','localized.piggy-banks.index.fr','localized.piggy-banks.show.tr','localized.piggy-banks.show.en',
'localized.piggy-banks.show.fr','localized.piggy-banks.update.tr','localized.piggy-banks.update.en','localized.piggy-banks.update.fr','localized.piggy-banks.pause.tr',
'localized.piggy-banks.pause.en','localized.piggy-banks.pause.fr','localized.piggy-banks.resume.tr','localized.piggy-banks.resume.en','localized.piggy-banks.resume.fr',
'localized.piggy-banks.update-status-cancelled.tr','localized.piggy-banks.update-status-cancelled.en','localized.piggy-banks.update-status-cancelled.fr','localized.piggy-banks.schedule.tr','localized.piggy-banks.schedule.en',
'localized.piggy-banks.schedule.fr','localized.piggy-banks.cancel.tr','localized.piggy-banks.cancel.en','localized.piggy-banks.cancel.fr','localized.test.set-date.tr',
'localized.test.set-date.en','localized.test.set-date.fr','localized.test.clear-date.tr','localized.test.clear-date.en','localized.test.clear-date.fr',
'localized.profile.edit.tr','localized.profile.edit.en','localized.profile.edit.fr','localized.profile.update.tr','localized.profile.update.en',
'localized.profile.update.fr','localized.profile.destroy.tr','localized.profile.destroy.en','localized.profile.destroy.fr','localized.terms.tr',
'localized.terms.en','localized.terms.fr','localized.privacy.tr','localized.privacy.en','localized.privacy.fr',
'localized.welcome','localized.create-piggy-bank.step-1.tr','localized.create-piggy-bank.step-1.en','localized.create-piggy-bank.step-1.fr','localized.create-piggy-bank.step-2.get.tr',
'localized.create-piggy-bank.step-2.get.en','localized.create-piggy-bank.step-2.get.fr','localized.create-piggy-bank.step-2.tr','localized.create-piggy-bank.step-2.en','localized.create-piggy-bank.step-2.fr',
'localized.create-piggy-bank.cancel.tr','localized.create-piggy-bank.cancel.en','localized.create-piggy-bank.cancel.fr','localized.create-piggy-bank.clear.tr','localized.create-piggy-bank.clear.en',
'localized.create-piggy-bank.clear.fr','localized.create-piggy-bank.choose-strategy.tr','localized.create-piggy-bank.choose-strategy.en','localized.create-piggy-bank.choose-strategy.fr','localized.create-piggy-bank.pick-date.step-3.tr',
'localized.create-piggy-bank.pick-date.step-3.en','localized.create-piggy-bank.pick-date.step-3.fr','localized.create-piggy-bank.pick-date.show-summary.tr','localized.create-piggy-bank.pick-date.show-summary.en','localized.create-piggy-bank.pick-date.show-summary.fr',
'localized.create-piggy-bank.pick-date.show-summary.post.tr','localized.create-piggy-bank.pick-date.show-summary.post.en','localized.create-piggy-bank.pick-date.show-summary.post.fr','localized.create-piggy-bank.pick-date.store.tr','localized.create-piggy-bank.pick-date.store.en',
'localized.create-piggy-bank.pick-date.store.fr','create-piggy-bank.api.link-preview','create-piggy-bank.get-flash-messages','create-piggy-bank.pick-date.calculate-frequencies','create-piggy-bank.pick-date.store-frequency',
'create-piggy-bank.pick-date.show-summary','create-piggy-bank.pick-date.store','localized.preferences.update','localized.scheduled-savings.update','localized.update-timezone',
'localized.format-date','global.language.switch','global.currency.switch','localized.login.tr',
'localized.login.en','localized.login.fr','localized.login.store.tr','localized.login.store.en','localized.login.store.fr',
'localized.register.tr','localized.register.en','localized.register.fr','localized.register.store.tr','localized.register.store.en',
'localized.register.store.fr','localized.password.request.tr','localized.password.request.en','localized.password.request.fr','localized.password.email.tr',
'localized.password.email.en','localized.password.email.fr','localized.password.reset.tr','localized.password.reset.en','localized.password.reset.fr',
'localized.password.reset.store.tr','localized.password.reset.store.en','localized.password.reset.store.fr','localized.verification.notice.tr','localized.verification.notice.en',
'localized.verification.notice.fr','localized.verification.verify.tr','localized.verification.verify.en','localized.verification.verify.fr','localized.verification.send.tr',
'localized.verification.send.en','localized.verification.send.fr','localized.logout.tr','localized.logout.en','localized.logout.fr',
'localized.password.confirm.tr','localized.password.confirm.en','localized.password.confirm.fr','localized.password.store.tr','localized.password.store.en',
'localized.password.store.fr','localized.password.update.tr','localized.password.update.en','localized.password.update.fr','login',
'storage.local',);
        registerArgumentsSet('views', 
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','components.application-logo','components.auth-session-status','components.confirmation-dialog','components.currency-dropdown',
'components.danger-button','components.dropdown','components.dropdown-link','components.empty-state','components.flash-message',
'components.input-error','components.input-label','components.language-dropdown','components.modal','components.nav-link',
'components.piggy-bank-card','components.primary-button','components.responsive-nav-link','components.secondary-button','components.text-input',
'components.unauthenticated-header','create-piggy-bank.common.step-1','create-piggy-bank.common.step-2','create-piggy-bank.enter-saving-amount.step-3','create-piggy-bank.pick-date.step-3',
'create-piggy-bank.pick-date.summary','dashboard','emails.admin.retry-alert','emails.saving-reminder','layouts.app',
'layouts.guest','layouts.navigation','legal.privacy','legal.terms','notifications::email',
'pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui','pagination::simple-bootstrap-4',
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','partials.schedule',
'piggy-banks.index','piggy-banks.show','profile.edit','profile.partials.delete-user-form','profile.partials.update-notification-preferences-form',
'profile.partials.update-password-form','profile.partials.update-profile-information-form','vendor.mail.html.button','vendor.mail.html.footer','vendor.mail.html.header',
...
'vendor.pagination.simple-default','vendor.pagination.simple-tailwind','vendor.pagination.tailwind','welcome','laravel-exceptions-renderer::components.card',
...
'pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui','pagination::simple-bootstrap-4',
'pagination::simple-bootstrap-5','pagination::simple-default','pagination::simple-tailwind','pagination::tailwind','postmark::template',);
        registerArgumentsSet('translations', 
'auth.failed','auth.password','auth.throttle','pagination.previous','pagination.next',
'pagination.showing','passwords.reset','passwords.sent','passwords.throttled','passwords.token',
...
'validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','validation.attributes.name','validation.attributes.price_whole',
'validation.attributes.price_cents','validation.attributes.starting_amount_whole','validation.attributes.starting_amount_cents','validation.attributes.currency','validation.attributes.link',
'validation.attributes.details','en.0','fr.0','tr.0','validation.attributes.password',);
...
'SESSION_PATH','SESSION_DOMAIN','SESSION_EXPIRE_ON_CLOSE','BROADCAST_CONNECTION','FILESYSTEM_DISK',
...
'VITE_APP_NAME','APP_DEFAULT_CURRENCY','POSTMARK_TOKEN',);
